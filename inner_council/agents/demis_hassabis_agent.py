...
class DemisHassabisAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        ...
        self.topic_patterns = {'ai': ['artificial intelligence', 'machine learning', 'neural', 'deep learning'], 'deep learning': ['deep learning', 'deep learning related'], 'neuroscience': ['neuroscience', 'neuroscience related'], 'technology': ['tech', 'innovation', 'software', 'hardware', 'blockchain']}

        logger.info("Demis Hassabis Agent initialized with specialized ai, deep learning, neuroscience, technology focus")
