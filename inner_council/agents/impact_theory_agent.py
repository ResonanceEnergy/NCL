...
class ImpactTheoryAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        super().__init__(
            ...
            focus_areas=['Business', 'Entrepreneurship', 'Psychology', 'Performance', 'Motivation'],
            priority="high",
        ...
        self.topic_patterns = {'business': ['business', 'startup', 'entrepreneur', 'finance', 'market'], 'entrepreneurship': ['entrepreneurship', 'entrepreneurship related'], 'psychology': ['psychology', 'psychology related'], 'performance': ['performance', 'performance related'], 'motivation': ['motivation', 'motivation related']}

        logger.info("Impact Theory Agent initialized with specialized business, entrepreneurship, psychology, performance, motivation focus")
