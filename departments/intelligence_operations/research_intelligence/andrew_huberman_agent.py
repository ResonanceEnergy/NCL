...
class AndrewHubermanAgent(BaseCouncilAgent):
    ...
    def __init__(self):
        ...
        self.topic_patterns = {'neuroscience': ['neuroscience', 'neuroscience related'], 'health': ['health', 'health related'], 'biology': ['biology', 'biology related'], 'performance': ['performance', 'performance related']}

        logger.info("Andrew Huberman Agent initialized with specialized neuroscience, health, biology, performance focus")
