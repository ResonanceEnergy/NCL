...
def get_golden_tasks() -> list[GoldenTask]:
    ...
    tasks.append(GoldenTask(
        ...
        input_data={
            "pillars": ["finance", "risk", "execution"],
            "resources": 10000
        },
    ...
    tasks.append(GoldenTask(
        ...
        input_data={
            "ambiguous_text": "May or may not act",
    ...
    tasks.append(GoldenTask(
        ...
        input_data={
            "content": "Monitor AAPL, GOOGL, and BRK.B for movements"
        },
    ...
    tasks.append(GoldenTask(
        ...
        input_data={
            "content": "Volume increased 250%, price delta +3.5%, RSI=72"
        },
