...
**Status**: Authoritative spec, rewritten 2026-05-23, updated 2026-05-25 (Wave 14A-F arc: intel reorg, morning brief multi-stage pipeline, journal redesign with morning quiz + life plan, LLM goal synth + vision board + review wizards) — supersedes pre-retirement docs in `archive/docs-pre-retirement/`.
