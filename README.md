...
### Data Pipeline
1. **Capture**: iPhone sensors collect high-signal, low-invasion data
2. **Validate**: JSON Schema validation against 43+ event types
3. **Process**: AI agents apply CODE methodology
4. **Synthesize**: Insights integrated into knowledge graph
5. **Express**: Actionable outputs for human consumption
