...
def test_launch_squadron_count():
    from future_predictor_council.src.agents import LAUNCH_SQUADRON
...
def test_callsign_map():
    from future_predictor_council.src.agents import CALLSIGN_MAP
...
def test_get_agent_by_codename():
    from future_predictor_council.src.agents import get_agent
    atlas = get_agent("mc")
...
def test_get_agent_by_callsign():
    from future_predictor_council.src.agents import get_agent_by_callsign
...
def test_get_agent_not_found():
    from future_predictor_council.src.agents import get_agent, get_agent_by_callsign
    assert get_agent("zz") is None
    assert get_agent_by_callsign("NONEXISTENT") is None


def test_list_agents_by_tier():
    from future_predictor_council.src.agents import AgentTier, list_agents
...
def test_mission_control_init():
    from future_predictor_council.src.agents.orchestrator import MissionControl
    mc = MissionControl()
...
def test_mission_control_loop_user_intent():
    from future_predictor_council.src.agents.orchestrator import MissionControl
    from future_predictor_council.src.agents.stubs import register_all
...
def test_mission_control_task_approve_reject():
    from future_predictor_council.src.agents.orchestrator import MissionControl, Task
...
def test_loop_phases():
    from future_predictor_council.src.agents.orchestrator import LoopPhase
...
def test_event_creation():
    from future_predictor_council.src.agents.events import Event, EventType
...
def test_event_helpers():
    from future_predictor_council.src.agents.events import (
        make_data_update,
        make_intent,
        make_model_cycle,
        make_telemetry,
...
def test_router_basic_routing():
    from future_predictor_council.src.agents.events import Event, EventType
    from future_predictor_council.src.agents.router import EventRouter
...
def test_router_privacy_gate():
    from future_predictor_council.src.agents.events import Event, EventType, PrivacyLevel, PrivacyTag
    from future_predictor_council.src.agents.router import EventRouter
...
def test_policy_budget_check():
    from future_predictor_council.src.agents.policy import PolicyEngine, PolicyVerdict
...
def test_policy_spend_tracking():
    from future_predictor_council.src.agents.policy import PolicyEngine
    pe = PolicyEngine.__new__(PolicyEngine)
    pe.steering = {"budget_weekly_usd": 50.0}
    pe.release_policy = {}
    pe.deploy_states = {}
...
def test_all_launch_stubs_registered():
    from future_predictor_council.src.agents.stubs import AGENT_STUBS
...
def test_register_all_with_mission_control():
    from future_predictor_council.src.agents.expansion import register_expansion
    from future_predictor_council.src.agents.orchestrator import MissionControl
    from future_predictor_council.src.agents.stubs import register_all
...
def test_live_boot():
    from future_predictor_council.src.agents.live import boot
    system = boot()
