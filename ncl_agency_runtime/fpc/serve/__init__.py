...
STEERING_PATH = pathlib.Path(__file__).resolve().parents[1] / "config" / "steering.json"
COUNCIL_PATH = pathlib.Path(__file__).resolve().parents[1] / "config" / "council_config.json"
